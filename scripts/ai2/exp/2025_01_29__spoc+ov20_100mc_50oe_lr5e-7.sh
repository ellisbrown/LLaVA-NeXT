...
###############  Data ################
# DATA_YAML_PATH="/data/weka/ellisb/LLaVA-NeXT/scripts/ai2/exp/2025_01_26_spoc_ov_mc+oe_v4.yaml"
DATA_YAML_PATH="/data/weka/ellisb/LLaVA-NeXT/scripts/train/spoc_50k+ov_20pct.yaml"
